    ...
    public function ganti_password(){
        if ($this->session->userdata('nik')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $password_lama = $this->input->post('password_lama'); $password_baru = $this->input->post('password_baru1');
                ...
                redirect('user/edit_profile');
                    ...
                    if ($password_lama == $password_baru) {
                        ...
                        $this->db->where('nik', $this->session->userdata('nik')); $this->db->update('tb_user');
